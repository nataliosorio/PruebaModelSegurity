    ...
    internal class DataInitial
    {
        public static void Data(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User { id = 1, username = "admin", email = "natiosoriopoveda@gmail.com", password = "pecas", personid = 1, active = true },
                new User { id = 2, username = "usuario", email = "marthapoveda579@gmail.com", password = "usuario123", personid = 2, active = true }
            );
            ...
            for (int formId = 1; formId <= 9; formId++)
            {
